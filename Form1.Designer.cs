...
namespace SmartImageForm_v1
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Smart Image Manager";
			// 
			// panel1
			// 
			...
			this.lblItemName.Location = new System.Drawing.Point(335, 8);
			this.lblItemName.Name = "lblItemName";
			this.lblItemName.Size = new System.Drawing.Size(89, 18);
			this.lblItemName.TabIndex = 6;
			this.lblItemName.Text = "ItemNumber";
			// 
			// label4
			// 
			...
			this.lblItemNumber.Location = new System.Drawing.Point(108, 8);
			this.lblItemNumber.Name = "lblItemNumber";
			this.lblItemNumber.Size = new System.Drawing.Size(89, 18);
			this.lblItemNumber.TabIndex = 4;
			this.lblItemNumber.Text = "ItemNumber";
			// 
			// label2
			// 
			...
			// btnImage1
			// 
			this.btnImage1.Location = new System.Drawing.Point(3, 3);
